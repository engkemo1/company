...
class AddJobContent extends StatefulWidget {
  const AddJobContent({Key? key}) : super(key: key);

  @override
  _AddJobContentState createState() =>
      _AddJobContentState();
}

class _AddJobContentState extends State<AddJobContent> {
